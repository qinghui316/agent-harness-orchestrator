...
const controlledSchedulerPostStepRoutingPreflightSupportSchema = z.object({
  authority: z.literal("non-executing-controlled-scheduler-post-step-routing-preflight-support"),
  sourceSchedulerControlledStepEvidenceId: z.string(),
  sourceSchedulerControlledStepArtifact: z.string(),
  sourceSchedulerControlledStepMarkdownArtifact: z.string().optional(),
  changeId: z.string(),
  sourceGoalLoopNextStepPacketId: z.string(),
  sourceGoalLoopControllerPolicyId: z.string(),
  sourceGoalLoopGateReadinessPreflightId: z.string().optional(),
  routeFamily: z.string(),
  ownerModule: z.string(),
  existingGateActionType: z.enum(WORKFLOW_ACTION_TYPES),
  continuationDecisionStatus: z.enum(["ready-for-human-gate", "quality-routing", "integration-barrier", "terminal-handoff"]),
  routingReadinessStatus: z.enum(["ready-for-human-gate", "quality-routing", "integration-barrier", "terminal-handoff"]),
  needsReevaluation: z.literal(false),
  reason: z.string(),
  currentGateScope: z.record(z.union([z.string(), z.array(z.string())])),
...
export const goalLoopGateReadinessPreflightSchema = z.object({
  ...
  schedulerExecutionMode: schedulerExecutionModeSchema,
  controlledSchedulerPostStepRoutingSupport: controlledSchedulerPostStepRoutingPreflightSupportSchema.optional(),
  summary: z.string(),
