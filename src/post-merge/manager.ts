...
const localSyncReadinessSchema: z.ZodType<LocalSyncReadiness> = z.object({
...
const cleanupReadinessSchema: z.ZodType<RemoteBranchCleanupReadiness> = z.object({
  version: z.literal("1.0"),
  id: z.string(),
  postMergeHandoffId: z.string(),
  remoteLandingResultId: z.string(),
...
const handoffSchema: z.ZodType<PostMergeHandoff> = z.object({
  version: z.literal("1.0"),
  id: z.string(),
  remoteLandingResultId: z.string(),
  landingPackageId: z.string(),
...
const stateSnapshotSchema: z.ZodType<PostMergeStateSnapshot> = z.object({
  version: z.literal("1.0"),
  id: z.string(),
  remoteLandingResultId: z.string(),
  landingPackageId: z.string(),
...
const localSyncResultSchema: z.ZodType<LocalSyncResult> = z.object({
  version: z.literal("1.0"),
  id: z.string(),
...
const cleanupResultSchema: z.ZodType<RemoteBranchCleanupResult> = z.object({
  version: z.literal("1.0"),
  id: z.string(),
  readinessId: z.string(),
  postMergeHandoffId: z.string(),
