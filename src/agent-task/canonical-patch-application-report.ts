...
function renderCanonicalPatchApplicationReportMarkdown(report: MaintenanceCanonicalPatchApplicationReport): string {
  return [
    ...
    "",
    ...renderMaintenanceMarkdownSection("Observed Operations", report.observedOperations.flatMap(renderCanonicalPatchObservedOperationMarkdownDetails)),
    "",
    ...renderMaintenanceMarkdownSection("Guardrails", renderMaintenanceMarkdownList(report.guardrailNotes)),
    "",
    ...renderMaintenanceMarkdownSection("Policy Audit", renderMaintenanceMarkdownList(report.policyAuditRefs, { emptyLabel: "none" })),
    "",
    ...renderMaintenanceMarkdownSection("Evidence", renderMaintenanceMarkdownList(report.artifactRefs)),
    "",
  ].join("\n");
}
