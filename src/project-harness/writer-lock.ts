...
export interface ProjectHarnessWriterLock {
  ...
  projectId: string;
  ownerId: string;
  operation: "init" | "migrate" | "change-publish" | "change-finalize" | "workflow-start" | "audit-accept" | "source-apply" | "worktree-discard" | "integration-check-apply" | "integration-check-discard" | "integration-finalize" | "evolution-publish";
  token: string;
  pid: number;
  acquiredAt: string;
  heartbeatAt: string;
