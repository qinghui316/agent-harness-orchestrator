...
import { attachGoalLoopFeedbackActions, goalLoopEvaluationQueueItem } from "./confirmation/goal-loop.js";
...
export async function buildConfirmationQueue(input: {
  ...
  queue.current = attachGoalLoopFeedbackActions(queue.current, input.workpad);
