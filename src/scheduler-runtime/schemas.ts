...
const schedulerControlledLoopTickPhaseStatusSchema = z.enum(["recorded", "completed", "warning"]);

const schedulerControlledLoopTickSummarySchema = z.object({
  version: z.literal("1.0"),
  authority: z.literal("scheduler-runtime-controlled-loop-tick-contract-summary"),
  observe: z.object({
    status: schedulerControlledLoopTickPhaseStatusSchema,
    goalLoopDecisionId: z.string(),
    goalLoopIterationId: z.string(),
    goalLoopContinuationBriefId: z.string(),
    goalLoopNextStepPacketId: z.string(),
    submittedActionType: z.string(),
  }),
  chooseCheck: z.object({
    status: schedulerControlledLoopTickPhaseStatusSchema,
    goalLoopControllerPolicyId: z.string(),
    goalLoopGateReadinessPreflightId: z.string(),
    targetScopeMatched: z.literal(true),
    concreteGatePreflightNonExecuting: z.literal(true),
  }),
  dispatch: z.object({
    ...
    approvedScopeOnly: z.literal(true),
  }),
  reconcile: z.object({
    status: schedulerControlledLoopTickPhaseStatusSchema,
    goalLoopDecisionId: z.string().optional(),
...
const schedulerControlledLoopContinuationReadinessSchema = z.object({
  version: z.literal("1.0"),
  authority: z.literal("scheduler-runtime-controlled-loop-continuation-readiness"),
...
const schedulerControlledLoopPostStepRoutingDecisionSchema = z.object({
  version: z.literal("1.0"),
  authority: z.literal("scheduler-runtime-controlled-loop-post-step-routing-decision"),
  routeFamily: z.enum(["waiting", "recommending-gate", "awaiting-human-gate", "quality-routing", "integration-barrier", "terminal-handoff"]),
  continuationReadinessStatus: z.enum(["ready-for-human-gate", "needs-review", "waiting", "quality-routing", "integration-barrier", "terminal-handoff"]),
  ownerModule: z.enum(["scheduler-runtime", "integration-check", "validation-audit", "goal-loop-current-gate", "existing-human-gate"]),
  executedActionType: z.string(),
  selectedActionType: z.string().optional(),
  dispatchedActionType: z.string().optional(),
  existingGateActionType: z.string().optional(),
  gateTargetScopeSource: z.enum(["dispatched-current-gate", "fresh-current-gate-required", "none"]),
  dispatchedTargetScope: z.record(controlledStepScopeValueSchema).optional(),
  resultKind: z.string().optional(),
  resultId: z.string().optional(),
  resultStatus: z.string().optional(),
  reason: z.string(),
  ...
  readinessEvidencePrepared: z.boolean(),
  needsReevaluation: z.boolean(),
  freshEvidenceRequiredBeforeContinuation: z.literal(true),
  freshCurrentGateRequiredBeforeContinuation: z.literal(true),
  humanGateRequired: z.boolean(),
  humanConfirmationStillRequired: z.literal(true),
  priorTurnEvidence: z.literal(true),
  evidenceRefs: z.array(z.string()),
  warning: z.string().optional(),
  executionStarted: z.literal(false),
  loopAuthorized: z.literal(false),
...
const schedulerControlledLoopIterationSummarySchema = z.object({
  ...
  status: z.enum(["completed", "completed-with-warning"]),
  executedActionType: z.string(),
  observeStatus: schedulerControlledLoopTickPhaseStatusSchema,
  chooseCheckStatus: schedulerControlledLoopTickPhaseStatusSchema,
  dispatchStatus: z.literal("completed"),
  reconcileStatus: schedulerControlledLoopTickPhaseStatusSchema,
  routePosture: z.enum(["waiting", "recommending-gate", "awaiting-human-gate", "quality-routing", "integration-barrier", "terminal-handoff"]),
  routeStopReason: z.string(),
  continuationReadinessStatus: z.enum(["ready-for-human-gate", "needs-review", "waiting", "quality-routing", "integration-barrier", "terminal-handoff"]),
  nextCandidateActionType: z.string().optional(),
  resultKind: z.string().optional(),
  resultId: z.string().optional(),
...
const schedulerControlledLoopStopSummarySchema = z.object({
  version: z.literal("1.0"),
  authority: z.literal("scheduler-runtime-controlled-loop-stop-summary"),
  executedActionType: z.string(),
  stopReason: z.string(),
  routePosture: z.enum(["waiting", "recommending-gate", "awaiting-human-gate", "quality-routing", "integration-barrier", "terminal-handoff"]),
  continuationReadinessStatus: z.enum(["ready-for-human-gate", "needs-review", "waiting", "quality-routing", "integration-barrier", "terminal-handoff"]),
...
const schedulerControlledLoopBoundaryResultSchema = z.object({
  version: z.literal("1.0"),
  authority: z.literal("scheduler-runtime-controlled-loop-boundary-result"),
  status: z.enum(["recorded", "recorded-with-warning"]),
  selectedActionType: z.string(),
  submittedActionType: z.string(),
  dispatchedActionType: z.string(),
  selectedGateScope: z.record(controlledStepScopeValueSchema),
  observeStatus: z.enum(["recorded", "completed", "warning"]),
  chooseCheckStatus: z.enum(["recorded", "completed", "warning"]),
  dispatchStatus: z.literal("completed"),
  reconcileStatus: z.enum(["recorded", "completed", "warning"]),
  boundaryPosture: z.enum(["waiting", "recommending-gate", "awaiting-human-gate", "quality-routing", "integration-barrier", "terminal-handoff"]),
  continuationReadinessStatus: z.enum(["ready-for-human-gate", "needs-review", "waiting", "quality-routing", "integration-barrier", "terminal-handoff"]),
  stopReason: z.string(),
  nextGateActionType: z.string().optional(),
  nextGateTargetScopeSource: z.literal("fresh-current-gate-required").optional(),
  resultKind: z.string().optional(),
  resultId: z.string().optional(),
  resultStatus: z.string().optional(),
  readinessEvidencePrepared: z.boolean(),
  ...
  humanGateRequired: z.boolean(),
  humanConfirmationStillRequired: z.literal(true),
  futureContinuationRequiresFreshEvidence: z.literal(true),
  futureContinuationRequiresFreshCurrentGate: z.literal(true),
  stoppedAfterOneSchedulerTransition: z.literal(true),
  approvedScopeOnly: z.literal(true),
  boundary: z.string(),
  evidenceRefs: z.array(z.string()),
...
const schedulerControlledLoopRuntimeBoundarySchema = z.object({
  version: z.literal("1.0"),
  authority: z.literal("scheduler-runtime-controlled-loop-runtime-boundary-evidence"),
  status: z.enum(["recorded", "recorded-with-warning"]),
  changeId: z.string(),
  ...
  dispatchedActionType: z.string(),
  observeStatus: z.enum(["recorded", "completed", "warning"]),
  chooseStatus: z.enum(["recorded", "completed", "warning"]),
  humanGateStatus: z.literal("confirmed-current-step"),
  dispatchStatus: z.literal("completed"),
  reconcileStatus: z.enum(["recorded", "completed", "warning"]),
  stopStatus: z.string(),
  stopPosture: z.enum(["waiting", "recommending-gate", "awaiting-human-gate", "quality-routing", "integration-barrier", "terminal-handoff"]),
  stopReason: z.string(),
  continuationReadinessStatus: z.enum(["ready-for-human-gate", "needs-review", "waiting", "quality-routing", "integration-barrier", "terminal-handoff"]),
  nextGateActionType: z.string().optional(),
  nextGateTargetScopeSource: z.enum(["fresh-current-gate-required", "none"]),
  resultKind: z.string().optional(),
  resultId: z.string().optional(),
  resultStatus: z.string().optional(),
  observedGoalLoopNextStepPacketId: z.string(),
  selectedGoalLoopGateReadinessPreflightId: z.string(),
  reconciledGoalLoopNextStepPacketId: z.string().optional(),
  readinessEvidencePrepared: z.boolean(),
  needsReevaluation: z.boolean(),
  humanConfirmationStillRequired: z.literal(true),
  stoppedAfterOneSchedulerTransition: z.literal(true),
...
const schedulerControlledLoopCurrentTransitionChoiceSchema = z.object({
  version: z.literal("1.0"),
  authority: z.literal("scheduler-runtime-current-transition-choice"),
  status: z.literal("ready-for-dispatch"),
  changeId: z.string(),
  selectedActionType: z.string(),
  submittedActionType: z.string(),
  currentGate: z.object({
    actionType: z.string(),
    scope: z.record(controlledStepScopeValueSchema),
  }),
  goalLoopDecisionId: z.string(),
  goalLoopIterationId: z.string(),
  goalLoopContinuationBriefId: z.string(),
...
export const schedulerControlledStepEvidenceSchema: z.ZodType<SchedulerControlledStepEvidence> = z.object({
  ...
  controlledLoopIteration: schedulerControlledLoopIterationSummarySchema.optional(),
  controlledLoopStopSummary: schedulerControlledLoopStopSummarySchema.optional(),
  controlledLoopBoundaryResult: schedulerControlledLoopBoundaryResultSchema.optional(),
  controlledLoopRuntimeBoundary: schedulerControlledLoopRuntimeBoundarySchema.optional(),
  controlledLoopPostStepRoutingDecision: schedulerControlledLoopPostStepRoutingDecisionSchema.optional(),
  controlledLoopCurrentTransitionChoice: schedulerControlledLoopCurrentTransitionChoiceSchema.optional(),
  executionStarted: z.literal(true),
  stoppedAfterOneSchedulerTransition: z.literal(true),
  humanConfirmationStillRequired: z.literal(true),
