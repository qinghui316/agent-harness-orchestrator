...
const stateSnapshotSchema: z.ZodType<RemoteLandingStateSnapshot> = z.object({
...
const readinessSchema: z.ZodType<RemoteLandingReadiness> = z.object({
  version: z.literal("1.0"),
  id: z.string(),
  prDraftPackageId: z.string(),
  landingPackageId: z.string(),
...
const attemptSchema: z.ZodType<RemoteLandingAttempt> = z.object({
  version: z.literal("1.0"),
  id: z.string(),
...
const resultSchema: z.ZodType<RemoteLandingResult> = z.object({
  version: z.literal("1.0"),
  id: z.string(),
  attemptId: z.string(),
  readinessId: z.string(),
    ...
    for (const changeId of landing.target.changeIds) {
      await recordDemandMemoryCloseout(memory, {
        ...
        memoryBoundaryNotes: [
          ...
          "Canonical docs, ECL, curated project/stable memory, product roadmap, Harness templates, and local source sync remain human-gated or future work.",
        ],
      });
    }
