...
import type { DemandWorker, DemandWorkerAttempt, ResolvedMemory } from "../types/index.js";
import { demandWorkerAttemptSchema, demandWorkerSchema } from "./schemas.js";
import { demandWorkerAttemptsRoot, demandWorkerPath, demandWorkersRoot } from "./paths.js";
...
export async function writeDemandWorker(memory: ResolvedMemory, worker: DemandWorker): Promise<DemandWorker> {
...
export async function writeDemandWorkerAttempt(memory: ResolvedMemory, attempt: DemandWorkerAttempt): Promise<DemandWorkerAttempt> {
