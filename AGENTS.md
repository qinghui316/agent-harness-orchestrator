...
- Latest archived product change: Phase 12B Scheduler Loop Evidence Snapshot, archived at `harness/changes/archive/20260618-phase-12b-scheduler-loop-evidence-snapshot/summary.md`.
