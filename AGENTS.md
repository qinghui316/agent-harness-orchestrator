...
- Latest archived product change: Controlled Scheduler Confirmation Routing Posture, archived at `harness/changes/archive/20260620-controlled-scheduler-confirmation-routing-posture/summary.md`.
- Latest product/Harness docs change: Controlled Scheduler Routing Window Noop, archived at `harness/changes/archive/20260620-auto-evolve-harness-controlled-scheduler-routing-window-noop/summary.md`.
