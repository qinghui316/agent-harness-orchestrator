...
- Active change: `harness/changes/active/phase-8m-scoped-change-lifecycle-boundary-split/summary.md`.
...
Current active phase: Phase 8M Scoped Change Lifecycle Boundary Split.
