...
- Latest archived product change: Maintenance Canonical Patch Target Kinds Helper Reuse, archived at `harness/changes/archive/20260619-maintenance-canonical-patch-target-kinds-helper-reuse/summary.md`.
- Latest product/Harness docs change: Maintenance Canonical Patch Target Kinds Helper Reuse, archived at `harness/changes/archive/20260619-maintenance-canonical-patch-target-kinds-helper-reuse/summary.md`.
