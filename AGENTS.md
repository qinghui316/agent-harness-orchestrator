...
- Latest archived product change: Phase 11K Goal Loop Scheduler Mode Preflight Handoff, archived at `harness/changes/archive/20260617-phase-11k-goal-loop-scheduler-mode-preflight-handoff/summary.md`.
- Latest product/Harness docs change: Phase 11K Goal Loop Scheduler Mode Preflight Handoff, archived at `harness/changes/archive/20260617-phase-11k-goal-loop-scheduler-mode-preflight-handoff/summary.md`.
