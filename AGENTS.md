...
- Latest archived product change: Maintenance Canonical Patch Application Artifact Ref Reuse, archived at `harness/changes/archive/20260619-maintenance-canonical-patch-application-artifact-ref-reuse/summary.md`.
- Latest product/Harness docs change: Maintenance Canonical Patch Application Artifact Ref Reuse, archived at `harness/changes/archive/20260619-maintenance-canonical-patch-application-artifact-ref-reuse/summary.md`.
