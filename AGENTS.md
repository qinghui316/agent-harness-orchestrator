...
- Active change: `harness/changes/active/phase-8v-validation-audit-runtime-continuity-coverage/summary.md`.
...
Current active phase: Phase 8V Validation Audit Runtime Continuity Coverage.
