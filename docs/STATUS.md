...
- Latest archived product change: `harness/changes/archive/20260620-workbench-agenttask-residual-test-domain-split/summary.md`.
- Latest archived product/Harness docs change: `harness/changes/archive/20260620-workbench-agenttask-residual-test-domain-split/summary.md`.
...
This file is the short resume point. There is no active ECL change and no pending Harness evolution. The latest product/docs change moved the final AgentTask/delegation/boundary residual coverage into `tests/unit/workbench-agent-task-domain.test.ts`, deleted `tests/unit/workbench.test.ts`, and updated the package test contract. The latest Harness evolution reviewed the five-change Workbench feedback/conversation split window and recorded `keep` with no new rule/template/lint/product runtime change.
...
Continue Architecture Growth Control from `docs/CURRENT-DEVELOPMENT-PLAN.md`. The residual Workbench monolith has been eliminated; future Workbench test work should keep new coverage in explicit capability-domain suites and focus convergence on shared fixtures or slow-suite placement only when evidence warrants. Keep `README.md` unrelated and untracked unless the user explicitly asks to include it.
...
- Latest product change: `harness/changes/archive/20260620-workbench-agenttask-residual-test-domain-split/summary.md`.
