...
- Active ECL change: `harness/changes/active/phase-9l-scheduler-first-worker-rework-execution-gate/summary.md`.
- Pending Harness evolution: none.
- Latest archived product change: `harness/changes/archive/20260612-phase-9k-scheduler-first-worker-bounded-rework-plan-contract/summary.md`.
...
- Active product phase: Phase 9L Scheduler First Worker Rework Execution Gate.
