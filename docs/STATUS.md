...
- Latest archived product change: `harness/changes/archive/20260620-workbench-goal-loop-surface-test-domain-split/summary.md`.
- Latest archived product/Harness docs change: `harness/changes/archive/20260620-workbench-goal-loop-surface-test-domain-split/summary.md`.
...
This file is the short resume point. There is no active ECL change and no pending Harness evolution. The latest archived product change split the Goal Loop Workbench surface tests into `tests/unit/workbench-goal-loop-surface.test.ts`, reused the shared Workbench fixture owner, and kept the new suite in the explicit `test:workbench` contract while excluding it from `test:fast`. The latest Harness evolution reviewed the five-change Workbench test-architecture split window and recorded `keep` with no new rule/template/lint/product runtime change.
...
- Latest product change: `harness/changes/archive/20260620-workbench-goal-loop-surface-test-domain-split/summary.md`.
