...
- Latest archived product change: `harness/changes/archive/20260620-workbench-landing-review-artifact-selection-helper-reuse/summary.md`.
- Latest archived product/Harness docs change: `harness/changes/archive/20260620-workbench-landing-review-artifact-selection-helper-reuse/summary.md`.
...
This file is the short resume point. There is no active ECL change and pending Harness evolution is none. The latest product change converged repeated Workbench landing review artifact display selection into a small shared helper without changing action ids, payloads, human gates, source/remote behavior, Goal Loop, Scheduler, ToolPolicy authority, PR/merge behavior, or landing package generation. The latest Harness evolution evaluated the helper reuse/projection owner window with result `keep / independent_review`; no durable rule/template/lint/docs/product runtime change was made.
