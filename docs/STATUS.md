...
- Latest archived product change: `harness/changes/archive/20260619-maintenance-canonical-patch-application-artifact-ref-reuse/summary.md`.
- Latest archived product/Harness docs change: `harness/changes/archive/20260619-maintenance-canonical-patch-application-artifact-ref-reuse/summary.md`.
...
This file is the short resume point. There is no active ECL change and no pending Harness evolution. The latest completed product convergence slice is Maintenance Canonical Patch Application Artifact Ref Reuse: canonical patch application manifest/result/report artifact-reference construction now lives in a narrow owner that reuses the generic maintenance artifact-store ref-list helper while preserving existing artifact refs, ledger event types, ledger summaries, authority flags, human gates, ToolPolicyGate, Workbench, scheduler, Goal Loop, Validation, Audit, IntegrationCheck, and Harness evolution behavior. The latest completed Harness evolution remains Auto-evolve Harness Maintenance Store Authority Reuse Window: `mark-complete` recorded `keep / independent_review`, retained existing Architecture Growth Control / Core Mechanism Reuse, Module Boundary, Documentation Entropy, Experience Lifecycle, workflow-truth, ToolPolicyGate, and human-gate rules, and made no new Harness rule/template/lint/product runtime change.
...
- Latest product change: `harness/changes/archive/20260619-maintenance-canonical-patch-application-artifact-ref-reuse/summary.md`.
- Previous product change: `harness/changes/archive/20260619-maintenance-canonical-ledger-summary-policy-reuse/summary.md`.
