...
Pending Harness evolution: `harness/evolution/pending.md`. It was generated by
the five-archive threshold after the confirmation feedback real UI scout close.
Do not auto-apply it; handle it through a separate Harness evolution structured
change with proposal, independent review, validation, `results.tsv`, and
`mark-complete`.
