...
- Latest archived product change: `harness/changes/archive/20260621-controlled-scheduler-runtime-step-evidence/summary.md`.
- Latest archived product/Harness docs change: `harness/changes/archive/20260621-controlled-scheduler-runtime-step-evidence/summary.md`.
...
This file is the short resume point. No pre-existing active change remains.
