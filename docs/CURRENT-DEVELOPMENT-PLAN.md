...
`harness/evolution/pending.md` was generated by the latest close. Treat it as a
separate human-gated Harness evolution task; do not fold it into product UI
work or auto-apply it through Workbench/full-access.
