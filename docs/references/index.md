...
| Deterministic WorkflowPlan shape, pipeline/barrier semantics, run events, and resume journal | `docs/design-docs/harness-workflow-runtime-target.md` and `docs/design-docs/ref-open-dynamic-workflows.md` | AHO's target doc defines the typed Harness runtime; Open Dynamic Workflows supplies the algorithm reference without becoming an AHO dependency or JS script surface. |
